 ...
 */
async function getValueLeakageSummary(practiceId) {
  ...
  const commitmentForWeighting = computePracticeCommitmentRate(plans, items, defaultWindowDays);
  ...
  const byClinicianRaw = computeCommitmentRateByClinician(plans, items, clinicianWindowDays);
