...
-- This corrects the 20260316000002 migration.
...
BEGIN
  ...
  -- Get profit settings from the representative provider row
  ...
  -- Call get_provider_net_production_monthly for each external_id and sum
  ...
  -- Call get_provider_working_hours_monthly for each external_id and sum
