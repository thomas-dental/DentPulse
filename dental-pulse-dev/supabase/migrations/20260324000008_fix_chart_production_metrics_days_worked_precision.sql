-- Fix chart_get_production_metrics: remove ROUND(days_count, 2) so days_worked
-- retains full precision (e.g. 32.6666... instead of 32.67).
-- This ensures VS Target on ProviderDetail matches Profit Goals Settings exactly.
