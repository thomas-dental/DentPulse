-- Function to calculate profit metrics per provider for chart
-- Uses the same logic as Profit Goals Settings page (ProviderDetail.tsx lines 750-844)
-- Calls get_provider_net_production_monthly and get_provider_working_hours_monthly
...
BEGIN
  ...
  -- Hardcoded Op Costs (matches UI - line 410)
  v_op_costs := 256976.70;
...
Calls get_provider_net_production_monthly and get_provider_working_hours_monthly procedures.
...
Returns provider_id (UUID), name, periodic profit, P/L per day, profit %, and rank.';
