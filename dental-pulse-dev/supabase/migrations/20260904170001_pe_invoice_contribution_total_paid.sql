-- Existing Patient Value hero: add total_paid_value (paid invoices, private + plan £).
...
COMMENT ON FUNCTION public.pe_invoice_contribution_summary(UUID, UUID, DATE, DATE) IS
  'Invoice contribution summary + total_paid_value (paid platform_integration_invoices, private+plan £).';
