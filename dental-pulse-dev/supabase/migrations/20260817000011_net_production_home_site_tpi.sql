-- ============================================================================
-- Daniel Grzybowski Appoline Apr-26: DentPulse £23,242.40 vs Dentally
-- Practitioner Activity £23,362.40.
--
-- 00010 dropped every TPI whose appointment clinician was a different
-- person (Zahid retainer guard). That also dropped Daniel's own £120
-- Extraction (tpi 2768408883, completed 13 Apr 2026) which he treated on
-- Renata Noori's appointment (339098). Dentally attributes by treatment
-- practitioner, so it stays on Daniel.
--
-- Keep the Zahid guard only for OTHER-SITE Dentally IDs (not a provider
-- at the selected location) that would otherwise be email-merged onto
-- this site. Home-site IDs always keep their own TPI.
--
-- Unchanged from 00010: practitioner = TPI practitioner; location =
-- appointment site; Foazia other-site IDs stay on that id; Dimitra
-- same-person mis-stamps still count via Path 2.
-- ============================================================================
